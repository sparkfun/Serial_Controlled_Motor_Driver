...
TimerClass outputTimer( 5 );  //Read knobs and drive motors
...
//	while(1);
	...
	myMotorDriver.inversionMode(2,0);
	while ( myMotorDriver.busy() );
	myMotorDriver.writeRegister(SCMD_E_BUS_SPEED, 0x02);
	while ( myMotorDriver.busy() );
	myMotorDriver.writeRegister(SCMD_UPDATE_RATE, 0x10);
